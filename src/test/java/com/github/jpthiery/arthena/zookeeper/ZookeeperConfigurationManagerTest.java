...
public class ZookeeperConfigurationManagerTest implements ConfigurationFixture {
  ...
  @Test
  public void itShouldStoreConfiguration() throws ConfigurationManager.ConfigurationAlreadyExist {
            ...
            """
{
  ...
  @Test
  public void itShouldUpdateConfigurationValue()
      throws ConfigurationManager.ConfigurationNotFound,
          ConfigurationManager.ConfigurationAlreadyExist {
  ...
  @Test
  public void itShouldNotStoreConfigurationTwice()
      throws ConfigurationManager.ConfigurationNotFound,
          ConfigurationManager.ConfigurationAlreadyExist {

    sut.store(CONFIGURATION);
    Assertions.assertThatThrownBy(() -> sut.store(CONFIGURATION))
        .isInstanceOf(ConfigurationManager.ConfigurationAlreadyExist.class);
  }
}
